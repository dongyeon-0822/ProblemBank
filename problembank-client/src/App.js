...
const TestProblem = React.lazy(() => import('./pages/TestProblem'));
const AfterTest = React.lazy(() => import('./pages/AfterTest'));
      ...
      <Suspense fallback = {<Loading type={'bars'} color={'black'} />}>
        <BrowserRouter>
            <Switch>
                ...
                <Route path = "/codingTest"  component = {CodingTest}/>
                <Route path = "/testProblem"  component = {TestProblem}/>
                <Route path = "/afterTest"  component = {AfterTest}/>
